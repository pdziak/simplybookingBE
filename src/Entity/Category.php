...
class Category
{
    ...
    #[Groups(['category:read', 'product:read', 'app:read', 'app:subdomain'])]
    private ?int $id = null;

    #[ORM\Column(type: 'string', length: 255)]
    #[Assert\NotBlank(message: 'Category name is required')]
    #[Groups(['category:read', 'category:write', 'product:read', 'app:read', 'app:subdomain'])]
    ...
    #[Groups(['category:read', 'app:read', 'app:subdomain'])]
